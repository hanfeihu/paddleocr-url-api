...
|---|---|---|---|---|
| macOS (bundled) | `.pkg` | `bash installer/build_pkg.sh` | `sudo installer -pkg dist/paddleocr-url-api-1.0.22.pkg -target /` | Bundles Python, wheels, models, and runs without install-time pip |
...
- Release target assets:
  - `paddleocr-url-api-1.0.22.pkg`
  - `ocr-url-api-setup-1.0.22.exe`

Windows package usage
1. Download `ocr-url-api-setup-1.0.22.exe` from GitHub Releases or the Windows installer artifact.
